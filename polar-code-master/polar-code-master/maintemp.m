...
%             figure(7);
%             plot(1:1:total_frame_num,EachFrameExecutorsBERs(6,:),'k-O','LineWidth',1.5,'MarkerSize',4)
%             hold on;
%             plot(1:1:total_frame_num,EachFrameExecutorsBERs(7,:),'k-d','LineWidth',1.5,'MarkerSize',4)
%             hold on;
%             plot(1:1:total_frame_num,EachFrameExecutorsBERs(8,:),'k-^','LineWidth',1.5,'MarkerSize',4)
%             hold on;
...
%         figure(8);
%         plot(ebn0,SystemBERs(1,:),'k-O','LineWidth',1.5,'MarkerSize',4)
%         hold on;
%         plot(ebn0,SystemBERs(2,:),'k-d','LineWidth',1.5,'MarkerSize',4)
%         hold on;
%         plot(ebn0,SystemBERs(3,:),'k-^','LineWidth',1.5,'MarkerSize',4)
%         hold on;
...
%         grid on;
    ...
    switch redundancy
        case 3
            semilogy(ebn0,SystemBERs(1,:),'k-.','LineWidth',1.5,'MarkerSize',4)
            hold on;
        case 4
            semilogy(ebn0,SystemBERs(2,:),'k-.','LineWidth',1.5,'MarkerSize',4)
            hold on;
        case 5
            semilogy(ebn0,SystemBERs(3,:),'k-.','LineWidth',1.5,'MarkerSize',4)
            hold on;
        otherwise
            fprintf('\n redundancy input error!!!');
    end
    semilogy(ebn0,ComparativeExecutorsBER(1,:),'-','LineWidth',1.5,'Color',[0.25,0.25,0.25])
    hold on;
    semilogy(ebn0,ComparativeExecutorsBER(2,:),'-.','LineWidth',1.5,'Color',[0.5,0.5,0.5])
    hold on;
    semilogy(ebn0,ComparativeExecutorsBER(3,:),'-','LineWidth',1.5,'Color',[0.75,0.75,0.75])
    hold on;
    semilogy(ebn0,ComparativeExecutorsBER(4,:),':','LineWidth',1.5,'Color',[0.5,0.5,0.5])
    hold on;
    semilogy(ebn0,ComparativeExecutorsBER(5,:),'--','LineWidth',1.5,'Color',[0.75,0.75,0.75])
    hold on;

    title('码率：',Rc);
    sgtitle('系统在不同码率下的误码率');
    xlabel('信噪比 (dB)')
    ylabel('误码率')
    ylim([-0.01 1.01])
    legend('BER of DHR polar decoder','BER of SC polar decoder','BER of BP polar decoder' ,...
