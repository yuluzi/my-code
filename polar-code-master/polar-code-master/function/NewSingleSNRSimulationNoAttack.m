function [ThreeSystemBERNum , ThreeSystemFERNum ,FourSystemBERNum , FourSystemFERNum,FiveSystemBERNum , FiveSystemFERNum, ...
    ...
    NewSingleSNRSimulationNoAttack(N,redundancy,K,ebn0,total_frame_num,max_frame_num,construction_method,attack_method,     ...
...
%                                     fprintf('\n running polar_SSC_decode now！');
                            ...
                            EachFrameNoneAttackExecutorsBERs(executors(i1),1) = TotalNoneAttackExecutorsBER(executors(i1),1);
                             %计算误码数和误帧数
