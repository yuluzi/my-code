function  [BER,FER,u_ThisExecutor] = RunABlock(N,K,u,executor,ebn0,ThisExecutorBER,ThisExecutorFER,bp_iter_num,scan_iter_num,scl_list_size,decoder_tree_initial, G_set, B_set)
