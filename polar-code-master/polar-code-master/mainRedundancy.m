...
EachFrameExecutorsBERs = zeros(8,total_frame_num);
for jj = 1:length(K)
    Rc = K(jj)/N;%码率
            ...
            case 0
                % DHR polar码仿真 
                 [ThreeSystemBERNum , ThreeSystemFERNum ,FourSystemBERNum , FourSystemFERNum,FiveSystemBERNum , FiveSystemFERNum, ...
                    ...
                    NewSingleSNRSimulationNoAttack(N,redundancy,K(jj),ebn0(j),total_frame_num,max_frame_num,construction_method,attack_method,   ...
